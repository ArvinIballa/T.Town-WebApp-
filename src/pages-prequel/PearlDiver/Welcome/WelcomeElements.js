...
export const ContainerBG = styled.div`
  height: 100%;
  width: 100%;
  background: url(${IMAGES.pearl_bg}) no-repeat center center;
...
export const GameDescription = styled.p`
  color: ${({design}) => design? '#d46dfc': 'white'};
