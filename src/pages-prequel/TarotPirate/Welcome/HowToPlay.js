...
const HowToPlay = ({showHowToPlayModal, closeHowToPlayModal}) => {
  ...
  const damageTiers = [
    {id: 1, tier: "No similar cards, 0 $SQUAWK"},
    {id: 2, tier: "1 pair of similar cards, _ $SQUAWK" },
    {id: 3, tier: "2 pairs of similar cards, _ $SQUAWK" },
    {id: 4, tier: "3 pairs of similar cards, _ $SQUAWK" },
  ]
      ...
      <Modal>
        <ModalSection>
          <ModalWrapper>
            ...
            <ModalBottom>
              <ModalSubtitleDiv>
                <ModalSubtitle>Win depending on the number of similar cards.</ModalSubtitle>
              ...
              <ModalSubtitle style={{color:'red'}}>*Note that the probability of winning prizes will be tiered depending on level of Pearl Necklace</ModalSubtitle>
              <ModalButtonDiv>
